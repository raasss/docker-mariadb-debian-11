# Docker Image for MariaDB on Debian 11 (Bulseye)

**Maintained by: [raasss](https://github.com/raasss/)**

### How do I use this docker image?

See [the Docker Hub page](https://hub.docker.com/repository/docker/raasss/mariadb-debian-11/general) or [GitHub page](https://github.com/raasss/docker-mariadb-debian-11/blob/main/README.docker.io.md) for the full README on how to use this container image.

## Reporting a Bug / Feature Request

If you run into any bugs or have ideas on new features you can file bug reports and feature requests on the [GitHub Issues](https://github.com/raasss/docker-mariadb-debian-11/issues).

## Contributing a Bug Fix / Feature Request

Contributing changes or feauters involves [creating a pull request](https://github.com/raasss/docker-mariadb-debian-11/pulls).
...
Before investing too much time in a feature request, please discuss its use on a [GitHub Issues](https://github.com/raasss/docker-mariadb-debian-11/issues).
...
The [full image description on Docker Hub](https://hub.docker.com/r/raasss/mariadb-debian-11) is located at [here](https://github.com/raasss/docker-mariadb-debian-11/blob/main/README.docker.io.md).

To change the documentation, please contribute a [pull request](https://github.com/raasss/docker-mariadb-debian-11/pulls) or [issue](https://github.com/raasss/docker-mariadb-debian-11/issues).
...
|:-:|
| [![latest](https://github.com/raasss/docker-mariadb-debian-11/actions/workflows/latest.yml/badge.svg)](https://github.com/raasss/docker-mariadb-debian-11/actions/workflows/latest.yml) |
